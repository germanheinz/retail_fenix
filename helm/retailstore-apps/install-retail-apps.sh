...
helm install catalog oci://public.ecr.aws/i5b4r2o0/retail-fenix/charts/catalog --version 1.1.0 -f values-catalog.yaml
sleep 10

# Step 02 - Cart Service
echo "--------------------------------------------"
echo "Installing Cart Service..."
helm install cart oci://public.ecr.aws/i5b4r2o0/retail-fenix/charts/cart --version 1.1.0 -f values-cart.yaml
sleep 10
...
helm install checkout \
  oci://public.ecr.aws/i5b4r2o0/retail-fenix/charts/checkout --version 1.1.0 -f values-checkout.yaml
sleep 10

# Step 04 - Orders Service
echo "--------------------------------------------"
echo "Installing Orders Service..."
helm install orders oci://public.ecr.aws/i5b4r2o0/retail-fenix/charts/orders --version 1.1.0 -f values-orders.yaml
sleep 10
...
helm install ui oci://public.ecr.aws/i5b4r2o0/retail-fenix/charts/ui --version 1.1.0 -f values-ui.yaml
sleep 10
